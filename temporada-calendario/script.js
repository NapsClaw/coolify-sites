...
function renderSitioCard(s, idx) {
  ...
  const ctaBtn = s.whatsapp
    ...
    : `<span class="sitio-card__contact-label">Configurar contato no painel</span>`;
    ...
    <div class="sitio-card">
      <div class="sitio-card__photo ${s.foto ? '' : PHOTO_PLACEHOLDERS[phIdx]}">
        ...
        <div class="sitio-card__badges">
          ...
          ${isAvail
            ? '<span class="sitio-card__avail-badge avail">✓ Disponível</span>'
            : '<span class="sitio-card__avail-badge unavail">Fora de temporada</span>'}
        </div>
      </div>
